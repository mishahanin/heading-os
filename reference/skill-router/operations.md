...
| `/canopus [plan \| lock \| check \| release \| back]` | NEVER auto-trigger. Explicit `/canopus [plan \| lock \| check \| release \| back]` only. Bare `/canopus` prints the current position and the full agenda. | N/A | No |
