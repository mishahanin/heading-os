...
- **Forced specifics that aren't true.** "Last Tuesday at the Dana office" is humanising only if it is also accurate. Inventing specifics is worse than generalising. When the specifics aren't known, ask Misha rather than fabricate.
