...
- "log a call with Tamsin, we talked about the PoV timeline and he's pushing for Q3"
...
- "update Tamsin's status to warm, we had a good call yesterday"
- "crm radar -- what needs attention this week"
- "log interaction with Marlow, quick sync about ExampleTelco pricing, he's aligned"
...
- "draft an email to Tamsin about the timeline" (email-draft skill)
