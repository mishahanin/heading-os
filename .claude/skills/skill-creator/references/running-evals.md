# Skill-Creator - Running and Evaluating Test Cases

Consumed by: `.claude/skills/skill-creator/SKILL.md` "Running and evaluating test cases" phase. Read when actually running evals against a draft skill (with-skill vs. baseline, grading, viewer launch, feedback collection).
